...
def destroy_all_instances
  ...
  LocationSubCategory.destroy_all
  Country.destroy_all
  Address.destroy_all
  ...
  PersonalRestriction.destroy_all
  User.destroy_all
  Event.destroy_all
  Edition.destroy_all
  Participant.destroy_all
  Booking.destroy_all
  BookingParticipant.destroy_all
  Post.destroy_all
  EventPost.destroy_all
  EditionPost.destroy_all
  BookingPost.destroy_all
  Comment.destroy_all
  ...
  VehicleFuel.destroy_all
  Vehicle.destroy_all
  Ride.destroy_all
  RideParticipant.destroy_all
  Questionnaire.destroy_all
  QuestionnaireQuestion.destroy_all
  QuestionnaireAnswer.destroy_all
end

### Location Categories
def create_location_categories
  puts '📍🏷️ Location Categories'
...
def create_location_sub_categories
  puts '📍🔖 Location Sub Categories'
...
def create_personal_restrictions
  puts '🙎‍♂️❌ Personal Restrictions'
...
### Edition Posts
def create_edition_posts
  puts '🎭🏞️ Edition Posts'
...
### Booking Posts
def create_booking_posts
  puts '📅🏞️ Booking Posts'
...
### Edition Items
def create_edition_items
  puts '🎭🏞️🔎 Edition Items'
...
### Vehicle Categories
def create_vehicle_categories
  puts '🚗🏷️ Vehicle Categories'
...
### Vehicle Brands
def create_vehicle_brands
  puts '🚗⚜️ Vehicle Brands'
...
### Ride Participants
def create_ride_participants
  puts '🚗🙎‍♂️🎭 Ride Participants'
...
def create_questionnaire_questions
  puts '❓ Questionnaire Questions'

  QuestionnaireQuestion.first_or_create([
    {
      questionnaire_id: 1,
...
def create_questionnaire_answers
  puts '❗️ Questionnaire Answers'

  QuestionnaireAnswer.first_or_create([
    {
...
# create_location_sub_categories()
# create_countries()
# create_addresses()
# create_locations()
# create_people()
...
# create_posts()
# create_event_posts()
# create_edition_posts()
# create_booking_posts()
# create_comments()
# create_reactions()
# create_items()
# create_edition_items()
# create_vehicle_categories()
# create_vehicle_brands()
# create_vehicle_models()
# create_vehicle_fuels()
# create_vehicles()
# create_rides()
# create_ride_participants()
